...
enum class CrateItem(
    ...
    RADISLI("Radisli Plushie", COMMON, "Boat goes Binted!", "plushies/player/radisli_slim"),
    JOEL("Joel Plushie", COMMON, "A Platypus? Perry the Platypus!", "plushies/player/joel_wide"),
    ...
    // Wearables
    CAT_EARS("Cat Ears", COMMON, "Cute cat ears", "cosmetics/hats/cat_ears"),
    DOG_EARS("Dog Ears", COMMON, "Cute dog ears", "cosmetics/hats/dog_ears"),
    FOX_EARS("Fox Ears", COMMON, "Cute fox ears", "cosmetics/hats/fox_ears"),
    COOL_GLASSES("Cool Glasses", UNCOMMON, "Stylish cool glasses", "cosmetics/hats/cool_glasses"),
    HALO("Halo", RARE, "A glowing halo", "cosmetics/hats/halo"),
    HEART_CROWN("Heart Crown", UNCOMMON, "A crown of hearts", "cosmetics/hats/heart_crown"),
    ORCHID_CROWN("Orchid Crown", UNCOMMON, "A crown of orchids", "cosmetics/hats/orchid_crown"),
    KING_CROWN("King Crown", UNCOMMON, "A majestic king's crown", "cosmetics/hats/king_crown"),
    HEART_GLASSES("Heart Glasses", COMMON, "Glasses with heart lenses", "cosmetics/hats/heart_glasses"),
    STRAWHAT("Strawhat", COMMON, "A simple Mugiwara", "cosmetics/hats/strawhat"),
    COPPER_ANTENNAS("Copper Antennas", COMMON, "Shiny copper antennas", "cosmetics/hats/copper_antennas"),
    COPPER_ANTENNAS_EXPOSED("Copper Antennas (Exposed)", UNCOMMON, "Shiny copper antennas, now with the wires exposed", "cosmetics/hats/copper_antennas_exposed"),
    COPPER_ANTENNAS_WEATHERED("Copper Antennas (Weathered)", RARE, "Shiny copper antennas, now weathered and old", "cosmetics/hats/copper_antennas_weathered"),
    COPPER_ANTENNAS_OXIDIZED("Copper Antennas (Oxidized)", EPIC, "Shiny copper antennas, now oxidized and green", "cosmetics/hats/copper_antennas_oxidized"),
    HORNS("Horns", COMMON, "Dragon Horns", "cosmetics/hats/horns"),
